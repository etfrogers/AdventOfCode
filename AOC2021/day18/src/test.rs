...
static SAMPLE_HW: &str = "[[[0,[5,8]],[[1,7],[9,6]]],[[4,[1,2]],[[1,4],2]]]
[[[5,[2,8]],4],[5,[[9,9],0]]]
[6,[[[6,2],[5,6]],[[7,6],[4,7]]]]
[[[6,[0,7]],[0,9]],[4,[9,[9,0]]]]
[[[7,[6,4]],[3,[1,3]]],[[[5,5],1],9]]
...
fn test_sum_magnitude() {
    let hw = Homework::from_str(SAMPLE_HW).unwrap();
    let expected =
...
fn test_pairwise() {
    let hw = Homework::from_str(SAMPLE_HW).unwrap();
    let expected = 3993;
    assert_eq!(hw.max_mag_pairwise_sum(), expected)
}
